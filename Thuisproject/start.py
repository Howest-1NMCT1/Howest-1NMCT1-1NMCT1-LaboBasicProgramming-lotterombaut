...
from Thuisproject.Model.Stadsmedewerker import Stadsmedewerker
...
print("taak voltooid --> melding bij standsmedewerker verwijderen")
...
# inlezen json-file
meldingen = Melding.inlezen_jsonfile()
...
dict_analyse = Melding.analyse_categorieen(meldingen)
